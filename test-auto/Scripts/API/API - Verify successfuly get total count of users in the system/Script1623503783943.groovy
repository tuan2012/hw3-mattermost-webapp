...
'Scope to a project'
RequestObject ScopeToProject = findTestObject('API/Get total count of users in the system')
...
// call api get total count of users in the system
'Get response text'
...
WS.containsString(response, 'total_users_count', false)
